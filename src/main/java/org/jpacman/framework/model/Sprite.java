...
public class Sprite {
	...
	/**
	 * The tile the sprite is occupying -- null if the sprite is disconnected.
	 */
	private Tile tile;

	/**
	 * Once the tile is set, the tile should indeed contain this sprite.
	 * 
	 * @return true iff this invariant holds.
	 */
	protected boolean spriteInvariant() {
		return tile == null || tile.containsSprite(this);
	}
	...
	public void occupy(Tile nextLocation) {
		...
		assert this.equals(nextLocation.topSprite()) : "Post: sprite at top of new tile.";
		assert spriteInvariant();
	}
