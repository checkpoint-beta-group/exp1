...
/**
 * Keep track of all activity that is going on during a game. Provide access to
 * key sprites in the game, such as the player and the ghosts. Provide
 * functionality to make moves on the board, and keep track of the points.
 * 
...
public class Game extends Observable implements IGameInteractor {
	...
	/**
	 * Player intends to move towards tile already occupied: if there's food there,
	 * eat it.
	 * 
	 * @param p
	 *            The player
	...
	/**
	 * Player intends to move towards an occupied tile: if there's a ghost there,
	 * the game is over.
	 * 
	 * @param p
	 *            The player
	 ...
	 * 
	 * @param target
	 *            Tile to be occupied by other sprite.
	 * @return
	 */
	 ...
	 * 
	 * @param o
	 *            The observer listening to this game.
	 */
	@Override
	 ...
	 * 
	 * @param pointManager
	 *            Responsible for keeping track of points.
	 */
