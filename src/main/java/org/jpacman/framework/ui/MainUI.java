...
public class MainUI extends JFrame implements Observer, IDisposable {
	...
	/**
	 * Create all the ui components and attach appropriate listeners.
	 * 
	 * @throws FactoryException
	 *             If resources for game can't be loaded.
	 */
	...
	/**
	 * Establish the appropriate size of the main window, based on the sizes of the
	...
	/**
	 * The state of the game has changed. Reset button enabling depending on the
	 * state.
	 * 
	 * @param o
	 *            Ignored
	...
	private Game createModel() throws FactoryException {
		MapParser parser = new MapParser(new DefaultGameFactory());
