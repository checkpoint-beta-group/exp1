...
/**
 * Class mapping events triggered by the UI to actions in the underlying Pacman
 * model.
 * 
...
public class PacmanInteraction implements IKeyboardEvents {
	...
	/**
	 * Move the player in the given direction, provided we are in the playing state.
	 * 
	 * @param dir
	 *            New direction.
	 */
