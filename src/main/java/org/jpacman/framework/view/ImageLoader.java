...
/**
 * The responsibilities of this class include obtaining images from file, that
 * can be used for animations of the player and the monsters in Pacman.
 *
...
public class ImageLoader {
	...
	/**
	 * Create an empty (non initialized) image factory requiring that all images are
	...
	/**
	 * Read images for player and monsters from file. Different images exist for
	 * different phases of the animation.
	 * 
	 * @throws FactoryException
	 *             if the images can't be found.
	 */
	public void loadImages() throws FactoryException {
		try {
			monsterImage = new Image[] {
					getImage("Ghost1.gif"), getImage("Ghost2.gif") 
			};
	...
	/**
	 * Get a player (pizza slice) in the appropriate direction at the given
	 * animation sequence.
	 * 
	 * @param dir
	 *            Direction pacman is moving to.
	 * @param anim
	 *            Animation step
	 ...
	 *            counter indicating which animation to use.
	...
	/**
	 * Obtain an image from a file / resource that can be found on the classpath.
	 * 
	 * @param name
	 *            The file containg, e.g., a .gif picture.
