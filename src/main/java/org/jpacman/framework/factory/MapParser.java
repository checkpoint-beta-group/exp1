...
/**
 * Turn a textual ASCII board representation into an actual board.
 *
...
public class MapParser {
	 ...
	 * 
	 * @param f
	 *            the factory used to instantiate objects.
	 */
	...
	/**
	 * Parse a textual representation of a board, and create the relevant
	 * corresponding objects.
	 * 
	 * @param map
	 *            Rectangular list of strings, one for each row.
	...
	public Game parseMap(String[] map) throws FactoryException {
		...
		for (int y = 0; y < height; y++) {
			if (map[y].length() != width) {
				throw new FactoryException("Row " + y + " has incorrect length.");
			}
	...
	/**
	 * @param spriteCode
	 *            The sort of sprite to be added
	 * @param x
	 *            x-axis
	 * @param y
	 *            y-axis
	 * @throws FactoryException
	 *             if the code is illegal.
	 */
	 ...
	 * 
	 * @param spriteCode
	 *            the char representing a sprite type
	 * @return a new sprite object.
	 * @throws FactoryException
	 *             if the char can't be handled.
	 */
	 ...
	 * 
	 * @param spriteCode
	 *            char representing a sprite
	 * @throws FactoryException
	 *             to tell that the char can't be handled.
	 */
	...
	private static InputStream getResourceStream(String fileName) throws FactoryException {
		...
		if (result == null) {
			throw new FactoryException(
					"Resource: " + fileName + " not found on classpath:" + System.getProperty("java.class.path"));
		}
		return result;
	}
	 ...
	 * 
	 * @param fileName
	 *            Resource on class path containing the map
	 * @return The map as a series of strings.
	 * @throws FactoryException
	 *             If reading the map file fails.
	 */
	 ...
	 * 
	 * @param br
	 *            Reader to access lines representing a map
	 * @return The map as a series of strings.
	 * @throws FactoryException
	 *             If reading the map file fails.
	 */
